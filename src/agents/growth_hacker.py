...
def register(hatchet_instance) -> type:
    ...
    @hatchet_instance.workflow(name="growth-hacker", on_crons=["0 11 * * 2"], timeout="30m")
    class _RegisteredGrowthHacker(GrowthHackerAgent):
        @hatchet_instance.step(timeout="15m", retries=2)
